...
import { fetchEmployeeWithMinSalary } from '../store/employeeSlice';
import '../styles/MaxSalaryEmployee.css';

export default function MinSalaryEmployee() {
  ...
  useEffect(() => {
    const loadEmployee = async () => {
      const result = await dispatch(fetchEmployeeWithMinSalary());
      if (fetchEmployeeWithMinSalary.fulfilled.match(result)) {
